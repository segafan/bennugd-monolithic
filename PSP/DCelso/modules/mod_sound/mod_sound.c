...
static int return_0( INSTANCE * my, int * params )
{
	return 0; // crop
}
...
{
    { "SOUND_INIT"          , ""     , TYPE_INT , return_0               },
    { "SOUND_CLOSE"         , ""     , TYPE_INT , return_0              },
    { "LOAD_SONG"           , "S"    , TYPE_INT , return_0          },
    { "PLAY_SONG"           , "II"   , TYPE_INT , return_0          },
    { "UNLOAD_SONG"         , "I"    , TYPE_INT , return_0        },
    { "STOP_SONG"           , ""     , TYPE_INT , return_0          },
    { "PAUSE_SONG"          , ""     , TYPE_INT , return_0         },
    { "RESUME_SONG"         , ""     , TYPE_INT , return_0        },
    { "SET_SONG_VOLUME"     , "I"    , TYPE_INT , return_0    },
    { "IS_PLAYING_SONG"     , ""     , TYPE_INT , return_0    },
    { "LOAD_WAV"            , "S"    , TYPE_INT , return_0           },
    { "PLAY_WAV"            , "II"   , TYPE_INT , return_0           },
    { "UNLOAD_WAV"          , "I"    , TYPE_INT , return_0         },
    { "STOP_WAV"            , "I"    , TYPE_INT , return_0           },
    { "PAUSE_WAV"           , "I"    , TYPE_INT , return_0          },
    { "RESUME_WAV"          , "I"    , TYPE_INT , return_0         },
    { "IS_PLAYING_WAV"      , "I"    , TYPE_INT , return_0     },
    { "SET_WAV_VOLUME"      , "II"   , TYPE_INT , return_0     },
    { "FADE_MUSIC_IN"       , "III"  , TYPE_INT , return_0      },
    { "FADE_MUSIC_OFF"      , "I"    , TYPE_INT , return_0     },
    { "SET_CHANNEL_VOLUME"  , "II"   , TYPE_INT , return_0 },
    { "RESERVE_CHANNELS"    , "I"    , TYPE_INT , return_0   },
    { "SET_PANNING"         , "III"  , TYPE_INT , return_0        },
    { "SET_POSITION"        , "III"  , TYPE_INT , return_0       },
    { "SET_DISTANCE"        , "II"   , TYPE_INT , return_0       },
    { "REVERSE_STEREO"      , "II"   , TYPE_INT , return_0     },
    { "PLAY_WAV"            , "III"  , TYPE_INT , return_0   },
    { "SET_MUSIC_POSITION"  , "F"    , TYPE_INT , return_0 },
    { "UNLOAD_SONG"         , "P"    , TYPE_INT , return_0       },
    { "UNLOAD_WAV"          , "P"    , TYPE_INT , return_0        },
    { 0                     , 0      , 0        , 0                           }
};
#else
