...
/**
 *  \brief If set to 0 then SDL won't fake your Android system's accelerometer as a joystick.
 * 
 *  By default SDL creates a virtual joystick device that actually contains accelerometer data.
 *  Setting this variable to "0" disables that behaviour. The default it "1"
 *
 *  This variable can be set to the following values:
 *    "0"       - Accelerometer won't be presented as a joystick
 *    "1"       - Accelerometer will be presented as a joystick
 */
#define SDL_HINT_ACCELASJOY "SDL_ACCELASJOY"
