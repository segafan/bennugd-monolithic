            ...
            switch (event->window.event) {
                case SDL_WINDOWEVENT_FOCUS_GAINED:
                    ...
                    if(SDL_WindowSurface)
                        SDL_FreeSurface(SDL_WindowSurface);
                    ...
                    SDL_VideoViewport.x = (window_w - SDL_WindowSurface->w)/2;
                    SDL_VideoViewport.y = (window_h - SDL_WindowSurface->h)/2;
                    SDL_VideoViewport.w = SDL_WindowSurface->w;
                    SDL_VideoViewport.h = SDL_WindowSurface->h;
