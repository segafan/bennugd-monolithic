	...
	mouseP();
        ...
        z=0;
            for (y=100;y<300;y+=40);
                 ...
                 CONSTRAINTSETPOSTSOLVEFUNC(size,"preSolve");
                 z=son;
                 frame;
            end
        end
...
begin
frame
     RemoveConstraint(getConstraintFatherA(joint) <>0 ? getConstraintFatherA(joint) : getConstraintFatherB(joint),joint);
end

function preSolve(int joint)
begin
