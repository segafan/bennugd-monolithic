...
CONDITIONALLY_STATIC int modmap_graphic_set( INSTANCE * my, int * params )
{
    GRAPH * map ;
...
CONDITIONALLY_STATIC int modmap_graphic_info( INSTANCE * my, int * params )
{
    GRAPH * map ;
...
CONDITIONALLY_STATIC int modmap_set_point( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_set_center( INSTANCE * my, int * params )
{
    GRAPH * bmp = bitmap_get( params[0], params[1] ) ;
    if ( !bmp ) return -1 ;
...
CONDITIONALLY_STATIC int modmap_get_point( INSTANCE * my, int * params )
{
    GRAPH * bmp ;
...
CONDITIONALLY_STATIC int modmap_load_png( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_load_pcx( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_save_png( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_map_buffer( INSTANCE * my, int * params )
{
    GRAPH * map ;
...
CONDITIONALLY_STATIC int modmap_map_clear( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_new_map( INSTANCE * my, int * params )
{
    GRAPH * map ;
...
CONDITIONALLY_STATIC int modmap_new_map_extend( INSTANCE * my, int * params )
{
    GRAPH * map ;
    map = bitmap_new_syslib( params[0], params[1], params[2] ) ;
...
CONDITIONALLY_STATIC int modmap_map_clone( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_map_put( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_map_xput( INSTANCE * my, int * params )
{
    GRAPH * dest = bitmap_get( params[0], params[1] ) ;
    GRAPH * orig = bitmap_get( params[0], params[2] ) ;
...
CONDITIONALLY_STATIC int modmap_map_xputnp( INSTANCE * my, int * params )
{
    GRAPH * dest = bitmap_get( params[0], params[1] ) ;
...
CONDITIONALLY_STATIC int modmap_map_name( INSTANCE * my, int * params )
{
    GRAPH * map = bitmap_get( params[0], params[1] );
    int result;
...
CONDITIONALLY_STATIC int modmap_map_set_name( INSTANCE * my, int * params )
{
    GRAPH * map = bitmap_get( params[0], params[1] );
...
CONDITIONALLY_STATIC int modmap_map_exists( INSTANCE * my, int * params )
{
    GRAPH * map = bitmap_get( params[0], params[1] );
    return map == NULL ? 0 : 1 ;
}
...
CONDITIONALLY_STATIC int modmap_map_block_copy( INSTANCE * my, int * params )
{
    GRAPH * dest, * orig ;
    REGION clip ;
...
CONDITIONALLY_STATIC int modmap_load_map( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_unload_map( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_save_map( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_load_pal( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_save_pal( INSTANCE * my, int * params )
{
    const char * palname = string_get( params[0] );
...
CONDITIONALLY_STATIC int modmap_save_system_pal( INSTANCE * my, int * params )
{
    const char * palname = string_get( params[0] );
...
CONDITIONALLY_STATIC int modmap_convert_palette( INSTANCE * my, int * params )
{
    GRAPH * map = bitmap_get( params[0], params[1] ) ;
...
CONDITIONALLY_STATIC int modmap_set_colors( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_get_colors( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_roll_palette( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_find_color( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_get_rgb( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_get_rgba( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_rgb( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_rgba( INSTANCE * my, int * params )
{
    return sys_pixel_format->depth > 8 ?
...
CONDITIONALLY_STATIC int modmap_fade_on( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_fade_off( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_create( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_clone( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_unload( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_refresh( INSTANCE * my, int * params )
{
    pal_refresh( NULL ) ;
    return 1;
}
...
CONDITIONALLY_STATIC int modmap_pal_refresh_2( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_map_assign( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_map_remove( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_map_getid( INSTANCE * my, int * params )
{
    GRAPH * bmp = bitmap_get( params[0], params[1] ) ;
...
CONDITIONALLY_STATIC int modmap_set_system_pal( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_set_system_pal_raw( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_set( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_pal_get( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_load_fpg( INSTANCE * my, int * params )
{
    int r;
...
CONDITIONALLY_STATIC int modmap_save_fpg( INSTANCE * my, int * params )
{
    int r;
...
CONDITIONALLY_STATIC int modmap_unload_fpg( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_fpg_exists( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_fpg_add( INSTANCE * my, int * params )
{
    GRAPH * orig = bitmap_get( params[2], params[3] );
    GRAPH * dest ;
...
CONDITIONALLY_STATIC int modmap_fpg_new( INSTANCE * my, int * params )
{
    return grlib_new();
}
...
CONDITIONALLY_STATIC int modmap_bgload_fpg( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_load_fnt( INSTANCE * my, int * params )
{
    char * text ;
    int r ;
...
CONDITIONALLY_STATIC int modmap_load_bdf( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_unload_fnt( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_fnt_new( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_fnt_new_charset( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_fnt_new_from_bitmap( INSTANCE * my, int * params )
{
    GRAPH * bmp = bitmap_get( params[0], params[1] ) ;
    if ( !bmp ) return -1;
...
CONDITIONALLY_STATIC int modmap_get_glyph( INSTANCE * my, int * params )
{
...
CONDITIONALLY_STATIC int modmap_set_glyph( INSTANCE * my, int * params )
{
    FONT  * font = gr_font_get( params[0] );
...
CONDITIONALLY_STATIC int modmap_save_fnt( INSTANCE * my, int * params )
{
    char * text ;
    int r ;
