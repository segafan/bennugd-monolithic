 ...
 * Please be advised that if you compile this file into BennuGD, your build will
 * be covered under the terms of version 2 or (at your option) any later
 * one of the GNU GPL license, instead of under BennuGD's standard Zlib license.
 */
