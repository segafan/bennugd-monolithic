...
begin
	...
	lphysics.ShapeType=TYPE_CONVEX_POLYGON;      //Le crea un cuerpo poligonal, es el más caro computacionalmente hablando, pero es el más exacto para ajustarle una forma
